...
class TestCasesControllerTest < ActionController::TestCase
  ...
  test "should create test_case" do
    assert_difference('TestCase.count') do
      post :create, test_case: { author: @test_case.author, case_id: @test_case.case_id, status: @test_case.status, summary: @test_case.summary }
    end
  ...
  test "should update test_case" do
    put :update, id: @test_case, test_case: { author: @test_case.author, case_id: @test_case.case_id, status: @test_case.status, summary: @test_case.summary }
    assert_redirected_to test_case_path(assigns(:test_case))
  end
